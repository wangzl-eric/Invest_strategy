...
class TestRiskEngine:
    ...
    def test_check_order_max_gross_notional(self):
        ...
        engine = RiskEngine()
        # Set position_notional small so we hit gross notional first
        # Position notional: 0 + 30k = 30k < 50k (passes position check)
        # Gross notional: 200k + 30k = 230k < 250k (still passes)
        # Need bigger order or smaller position to trigger gross check
