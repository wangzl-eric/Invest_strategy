...
from core.llm_client import VerdictExplanation, VerdictLLMClient, generate_verdict
...
class TestVerdictLLMClient:
    ...
    def mock_llm_client(self):
        ...
        with patch("core.llm_client.QwenLLMClient.__init__") as mock_init:
    ...
    async def test_generate_verdict_success(self, mock_llm_client):
        ...
        with patch("core.llm_client.httpx.AsyncClient") as mock_client:
            ...
            with patch("core.llm_client.get_token_tracker") as mock_tracker:
...
class TestGenerateVerdictConvenience:
    ...
    async def test_generate_verdict_function(self):
        ...
        with patch("core.llm_client.VerdictLLMClient") as MockClient:
