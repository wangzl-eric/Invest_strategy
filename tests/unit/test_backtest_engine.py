...
pytestmark = pytest.mark.skipif(not has_backtrader(), reason="backtrader not installed")
...
class TestBacktestEngine:
    ...
    def test_add_strategy_creates_cerebro(self):
        ...
        from backend.backtest_engine import BacktestEngine, create_momentum_strategy
...
class TestLiveTradingEngineExtended:
    ...
    def test_add_strategy_requires_cerebro(self):
        ...
        from backend.backtest_engine import LiveTradingEngine, create_momentum_strategy
...
class TestAdditionalCoverage:
    ...
    def test_signal_strategy_with_series_signal(self):
        ...
        signals = pd.Series(
            [0, 1, 0, -1, 1], index=pd.date_range("2023-01-01", periods=5)
        )
