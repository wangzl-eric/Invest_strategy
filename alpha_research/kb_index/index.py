...
git-versioned YAML manifests are canonical and SQLite is derived, gitignored state.
    ...
    python3 -m alpha_research.kb_index.index --build     rebuild from markdown
    python3 -m alpha_research.kb_index.index --check     assert index matches markdown
    python3 -m alpha_research.kb_index.index --stats     what is in the pool
"""
...
from alpha_research.kb_index import parser
...
WATCHED = (
    "knowledge/reports/IDEAS.md",
    "knowledge/brain/VERDICTS.md",
)
