...
class PortfolioBuilder:
    ...
    def compute_signals(
        ...
        """
        from backtests.strategies.signals import get_signal, compute_signal_pandas
    ...
    def optimize_weights(
        ...
        from portfolio.risk import ledoit_wolf_cov, sample_cov
    ...
    def get_portfolio_metrics(self) -> Dict[str, float]:
        ...
        portfolio["total_value"] = portfolio[
            [c for c in portfolio.columns if c.endswith("_y") or c == "weighted_value"]
        ].sum(axis=1)
