...
Use `workstation/playground/data_helpers.py` for simplified access:

```python
from workstation.playground.data_helpers import get_prices, get_macro_series
...
# Correlation heatmap
from workstation.playground.data_helpers import get_correlation_matrix
...
```python
from workstation.playground.data_helpers import calculate_returns, calculate_volatility
...
# 2. Load data
from workstation.playground.data_helpers import get_prices
spy = get_prices('SPY', start='2020-01-01')
tlt = get_prices('TLT', start='2020-01-01')
...
- `workstation/playground/data_helpers.py` - Data access functions
