...
| `flows` | [cta-bond-futures](2026/06/flows_gs_cta-bond-futures_2026-06-09.md) | 【GS先物】CTA グローバル債券先物 週次アップデート (CTA Global Bond Futures Weekly) | Goldman Sachs — FICC Futures Sales desk color (not GIR) | 2026-06-09 | 3/4/3 | **direct** · limited <br><sub>rank 10/10</sub> |
