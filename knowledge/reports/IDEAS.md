...
*study:* [2026-03-29_expected_returns_ilmanen](../books/2026-03-29_expected_returns_ilmanen/er_book_briefing.md)
...
*study:* [2026-03-29_expected_returns_ilmanen](../books/2026-03-29_expected_returns_ilmanen/er_book_briefing.md) · [2026-06-24_volatility_workstation](../studies/2026-06-24_volatility_workstation/README.md)
...
*study:* [2026-03-26_fixed_income_relative_value_analysis_2e](../books/2026-03-26_fixed_income_relative_value_analysis_2e/firv_book_briefing.md)
...
*study:* [2026-06-17_advances_financial_ml](../books/2026-06-17_advances_financial_ml/study_hypotheses.md)
...
*study:* [2026-03-27_global_macro_trading_gliner](../books/2026-03-27_global_macro_trading_gliner/gmt_book_briefing.md)
...
| Testability | **2/5** | Verified: there is NO options pricing or P&L module anywhere in alpha_research/backtests — only the exploratory knowledge/studies/_legacy/vix_futures_options_research.ipynb. FX implied vol and 25-delta risk reversals are absent. Spot-side proxies (USDJPY=X, CFTC positioning) test whether drawdown scales with carry width, but 'is the convexity cheap?' cannot be answered here. The polygon connector exists but implements equity aggregates only. |
...
*study:* [2026-03-27_global_macro_trading_gliner](../books/2026-03-27_global_macro_trading_gliner/gmt_book_briefing.md) · [2026-03-29_expected_returns_ilmanen](../books/2026-03-29_expected_returns_ilmanen/er_book_briefing.md)
...
| Testability | **2/5** | Barely testable as a market claim. The only real test needs a labelled archive of dated desk calls scored on outcome, split by whether corroborating figures came from independent models — requiring the archive first. knowledge/reports/ is the natural seed (10 digests, verified) but nowhere near large enough. A reachable proxy: Philadelphia Fed SPF individual-forecaster microdata (free) to measure within-forecaster vs across-forecaster cross-variable error correlation, which quantifies how little diversification a single house view provides — adjacent to, not identical with, the claim. |
...
*study:* [2026-06-24_volatility_workstation](../studies/2026-06-24_volatility_workstation/README.md) · [2026-03-29_expected_returns_ilmanen](../books/2026-03-29_expected_returns_ilmanen/er_book_briefing.md)
...
- [IDEA-043](#idea-043) publisher-credibility-ledger: economic rationale 3 -> 2 (merged). No market counterparty at all. Testability held at 3 on verification that knowledge/reports/ holds 10 digests — the archive seed is real but only ~3-5 entries are scorable against a ~30-entry minimum.
