...
L1  source-faithful digest        preserves the AUTHOR'S argument          knowledge/{reports,papers,studies}/
...
`knowledge/domains/KNOWLEDGE_*.md` structure they were rescued from.
...
| Verdicts | **13 records**, rescued from `knowledge/domains/` before further rot |
| Inbox | live, empty |
...
- `knowledge/domains/KNOWLEDGE_{EQUITY,FX,MACRO,VOL}.md` — the verdict content is rescued into
