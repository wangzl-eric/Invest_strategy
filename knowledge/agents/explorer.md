...
- `knowledge/domains/KNOWLEDGE_FX.md`
- `knowledge/domains/KNOWLEDGE_EQUITY.md`
- `knowledge/domains/KNOWLEDGE_MACRO.md`
- `knowledge/domains/KNOWLEDGE_VOL.md`
...
### Market Data (via `alpha_research.quant_data.api`)
...
- **`alpha_research.quant_data.api`** - `get_data()` to load market data for scanning
