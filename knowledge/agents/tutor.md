...
### Guide Tool Usage
- Show how to use `alpha_research.quant_data.api` (`get_data`/`get_prices`/`get_fred`)
...
wide = (get_data(['SPY', 'TLT'], start='2020-01-01')
...
### Notebooks
- `knowledge/tutorials/00_getting_started.ipynb` - Platform tour
...
### Existing Tutorials
- `knowledge/tutorials/01_beginner_research.ipynb` - Backtrader basics
- `knowledge/tutorials/06_portfolio_builder.ipynb` - Portfolio optimization
- `knowledge/tutorials/04_signal_research.ipynb` - Signal development
