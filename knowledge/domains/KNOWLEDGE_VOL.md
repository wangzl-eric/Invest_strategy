...
> [`knowledge/brain/VERDICTS.md`](../../knowledge/brain/VERDICTS.md);
> the concept and paper content is superseded by
> [`brain/concepts/`](../../knowledge/brain/concepts/) and
> [`knowledge/papers/`](../../knowledge/papers/INDEX.md).
>
...
> [`INBOX.md`](../../knowledge/brain/INBOX.md).
