...
- In the local study folder, it should eventually sit on top of the existing implementation notebooks:
  - [03_carry_strategies.ipynb](../notebooks/03_carry_strategies.ipynb)
  - [04_momentum.ipynb](../notebooks/04_momentum.ipynb)
  - [05_volatility_risk_premium.ipynb](../notebooks/05_volatility_risk_premium.ipynb)
