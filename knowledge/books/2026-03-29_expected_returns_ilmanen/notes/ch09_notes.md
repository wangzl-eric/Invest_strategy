...
- This chapter is the fixed-income counterpart to [ch07_notes.md](./ch07_notes.md) and depends heavily on the interaction logic summarized in [ch08_notes.md](./ch08_notes.md).
