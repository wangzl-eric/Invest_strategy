...
This chapter also informs the interpretation of [ch17_notes.md](ch17_notes.md), because global bond RV cannot ignore financing differences across jurisdictions.
...
1. Add repo / haircut assumptions explicitly into [04_asset_swaps.ipynb](../notebooks/04_asset_swaps.ipynb) as placeholders.
