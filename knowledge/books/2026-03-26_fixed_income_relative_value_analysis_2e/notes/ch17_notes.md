...
- [03_fitted_curves.ipynb](../notebooks/03_fitted_curves.ipynb)

Secondary notebooks:

- [04_asset_swaps.ipynb](../notebooks/04_asset_swaps.ipynb)
- [05_cross_currency_basis.ipynb](../notebooks/05_cross_currency_basis.ipynb)
...
1. Extend [03_fitted_curves.ipynb](../notebooks/03_fitted_curves.ipynb) so local residual ranking is robust.
2. Keep [04_asset_swaps.ipynb](../notebooks/04_asset_swaps.ipynb) and [05_cross_currency_basis.ipynb](../notebooks/05_cross_currency_basis.ipynb) aligned with this eventual global comparison framework.
