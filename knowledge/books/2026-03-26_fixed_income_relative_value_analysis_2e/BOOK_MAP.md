...
This note follows the briefing in [firv_book_briefing.md](firv_book_briefing.md):
...
- Treasury $2s5s10s$ butterfly proxy in [01_mean_reversion.ipynb](notebooks/01_mean_reversion.ipynb)
...
**Practical proxy already scaffolded**
- Treasury PCA and PCA-neutral trade placeholders in [02_pca_yield_curve.ipynb](notebooks/02_pca_yield_curve.ipynb)
...
**Practical proxy already scaffolded**
- Nelson-Siegel-style curve fit placeholder in [03_fitted_curves.ipynb](notebooks/03_fitted_curves.ipynb)
...
**Practical scaffold**
- [04_asset_swaps.ipynb](notebooks/04_asset_swaps.ipynb)
...
**Practical scaffold**
- Chapter 15 placeholder in [05_cross_currency_basis.ipynb](notebooks/05_cross_currency_basis.ipynb)
