...
This file follows the briefing protocol in [firv_book_briefing.md](firv_book_briefing.md): track the argument arc, extract technicalities, note how chapters build on each other, and preserve context across sessions.
