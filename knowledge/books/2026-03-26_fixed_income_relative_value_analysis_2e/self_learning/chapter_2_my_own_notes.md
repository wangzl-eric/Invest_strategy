...
**Cross-reference:** See [`ch02_notes.md`](../notes/ch02_notes.md) Section 2 for discrete-time estimation formulas.
...
**Cross-reference:** See [`ch02_notes.md`](../notes/ch02_notes.md) Section 4 for state-dependent drift and diffusion discussion.
...
**Cross-reference:** Implement diagnostic graphs in [`01_mean_reversion.ipynb`](../notebooks/01_mean_reversion.ipynb) — see notebook cells for drift/diffusion estimation.
...
**Cross-reference:** See [`ch02_notes.md`](../notes/ch02_notes.md) Section 6 for ex ante risk-adjusted return framework.
...
**Cross-reference:** See [`ch02_notes.md`](../notes/ch02_notes.md) Section 7 for execution optimization framework.
...
**Cross-reference:** Replicate this workflow in [`01_mean_reversion.ipynb`](../notebooks/01_mean_reversion.ipynb) using Treasury butterfly proxy.
...
### Related Files
- [`ch02_notes.md`](../notes/ch02_notes.md) — Comprehensive chapter notes with framework summary
- [`chapter_2_qa_response.md`](./chapter_2_qa_response.md) — Detailed Q&A responses
- [`01_mean_reversion.ipynb`](../notebooks/01_mean_reversion.ipynb) — Practical implementation notebook
